...
class Interceptor extends \Magento\GiftWrappingGraphQl\Model\Resolver\Order\Item\GiftWrapping implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\GiftWrapping\Api\WrappingRepositoryInterface $wrappingRepository, \Magento\Sales\Api\OrderItemRepositoryInterface $orderItemRepository)
    {
        $this->___init();
        parent::__construct($wrappingRepository, $orderItemRepository);
    }
